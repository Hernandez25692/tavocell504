...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-100">
    ...
    <p class="text-2xl font-semibold text-gray-800 mb-2">Error interno del servidor</p>
    <p class="text-gray-600 text-center max-w-md mb-6">
        Lo sentimos, ha ocurrido un problema inesperado. Estamos trabajando para solucionarlo.
    </p>
