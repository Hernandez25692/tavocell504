    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
            ...
            <a href="{{ route('productos.create') }}"
                class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded shadow flex items-center transition">
        ...
        <form method="GET" action="{{ route('productos.index') }}" class="mb-6 max-w-md">
        ...
        @if (session('success'))
            <div
                class="bg-green-100 text-green-800 px-4 py-3 rounded shadow mb-4 border-l-4 border-green-500 flex items-center">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($productos as $producto)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-gray-900 font-semibold">L.
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <button
                                        onclick="confirmDelete('{{ $producto->nombre }}', '{{ route('productos.destroy', $producto) }}')"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-400">No se encontraron productos.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl animate-fade-in">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    @method('DELETE')
                    <button type="submit"
                        class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition">Eliminar</button>
                </form>
            </div>
        </div>
    </div>
