                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start gap-3 bg-gray-50/50 p-3 rounded-lg border border-gray-200/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800 font-medium">{{ $reparacion->marca }} {{ $reparacion->modelo }}
                                    </p>
                                    <p class="text-sm text-gray-600 mt-1"><span class="font-medium">Falla:</span>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3 bg-gray-50/50 p-3 rounded-lg border border-gray-200/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-800"><span class="font-medium">Costo:</span> L.
                                        {{ number_format($reparacion->costo_total, 2) }}</p>
                                    <p class="text-gray-800"><span class="font-medium">Abonado:</span> L.
                                        {{ number_format($reparacion->abono, 2) }}</p>
                                    @php $pendiente = $reparacion->costo_total - $reparacion->abono; @endphp
                                    @if ($pendiente > 0)
                                        <p class="text-red-600 font-medium"><span class="font-medium">Pendiente:</span> L.
                    ...
                    <form action="{{ route('seguimientos.store', $reparacion) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div
                                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-indigo-400 transition duration-200">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700 mb-4">
                                    El cliente aún debe <span class="font-bold text-red-600">L.
                ...
                <div class="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/20">
                    ...
                    @if ($reparacion->seguimientos->count() > 0)
                        <div class="relative">
                            <!-- Línea vertical -->
                            <div
                                class="absolute left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-indigo-300 to-indigo-500 rounded-full">
                            </div>
                            ...
                            <div class="space-y-8 pl-10">
                                @foreach ($reparacion->seguimientos as $seg)
                                    <div class="relative">
                                        ...
                                        <div
                                            class="absolute -left-10 top-1 w-6 h-6 bg-indigo-600 rounded-full border-4 border-white shadow-md z-10 flex items-center justify-center">
                                            <i
                                                class="fas 
                                    {match($seg->estado) {
                                        ...
                                        <div
                                            class="bg-gray-50 border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                                            ...
                                            <div class="mb-4">
                                                <div class="flex items-center gap-2 mb-2">
                                                    ...
                                                    <span class="text-sm font-medium text-gray-700">Técnico:
                                                        {{ $seg->tecnico->name }}</span>
                                                </div>
                                                <div class="bg-white p-4 rounded-lg border border-gray-200">
                                                    <p class="text-gray-700 whitespace-pre-line">{{ $seg->descripcion }}
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                                                        @foreach ($seg->imagenes as $img)
                                                            <a href="{{ asset('storage/' . $img->ruta_imagen) }}"
                                                                ...
                                                                class="block group">
                                                                <div
                                                                    class="aspect-w-1 aspect-h-1 overflow-hidden rounded-xl border border-gray-200 shadow-sm group-hover:shadow-md transition duration-300">
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-center mb-2">
                            <div class="text-sm text-gray-600">
                                <span class="font-semibold">Costo Total:</span> L.
                                {{ number_format($reparacion->costo_total, 2) }}
                            </div>
                            <div class="text-sm text-gray-600">
                                <span class="font-semibold">Total Abonado:</span> L.
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    {{ $abono->created_at->format('d/m/Y') }}</div>
                                                <div class="text-xs text-gray-500">
                                                    {{ $abono->created_at->format('h:i A') }}</div>
                                            </td>
                ...
                files.forEach(file => {
                    if (file.type.startsWith('image/')) {
                        ...
                        reader.onload = function(e) {
                            ...
                            div.classList.add('relative', 'group', 'overflow-hidden', 'rounded-xl',
